#Sample AWS Lambda function for Notifications
A simple [AWS Lambda](http://aws.amazon.com/lambda) function that demonstrates how to write a skill for the Notification skill using the Alexa SDK.
...
4. Name the Lambda Function "Notification".
...
2. Set "Notification" as the skill name and "Note" as the invocation name, this is what is used to activate your skill. For example you would say: "Alexa, tell Node to say hello"
